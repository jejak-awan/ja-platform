...
abstract class TestCase extends BaseTestCase
{
    ...
    protected function seedPermissionsAndRoles(): void
    {
        ...
        $permissions = [
            ...
            'view activity logs',
            'view security logs',
            // School & Academic (names must match Spatie permissions + School policies)
            'manager school', 'view schools', 'manage schools', 'create schools', 'edit schools', 'delete schools',
            'manage academic', 'view academic', 'manage curriculum', 'manage schedule', 'grade assignments', 'input journal', 'manage question bank',
            'manage lms', 'view lms', 'create lms', 'edit lms', 'delete lms',
            'view students', 'manage students', 'create students', 'edit students', 'delete students',
            'view staff', 'manage staff', 'create staff', 'edit staff', 'delete staff',
            'view attendance', 'manage attendance', 'view student affairs', 'manage student affairs',
            'view visitors', 'manage visitors',
            'view school finance', 'manage school finance', 'view osis', 'manage osis', 'view admission', 'manage admission',
            'view school extensions', 'manage school extensions', 'view sarpras', 'manage sarpras', 'manage inventory', 'manage logistics',
            'manage payroll',
        ];
