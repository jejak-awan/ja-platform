...
class DeveloperKitScaffolderTest extends TestCase
{
    ...
    {
        $localPath = base_path("Plugins/{$this->localPluginSlug}");
        if (File::isDirectory($localPath)) {
            File::deleteDirectory($localPath);
        }

        $downloadPath = base_path("Plugins/{$this->downloadPluginSlug}");
    ...
    public function test_scaffolder_local_installation(): void
    {
        ...
        $pluginDir = base_path("Plugins/{$this->localPluginSlug}");
