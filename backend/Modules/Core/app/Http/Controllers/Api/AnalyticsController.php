...
class AnalyticsController extends BaseApiController
{
    ...
    public function events(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        /** @var \Illuminate\Pagination\LengthAwarePaginator<int, \Modules\Core\Models\AnalyticsEvent> $events */
    ...
    {
        try {
            $daysVisitsRaw = \Modules\Core\Models\Setting::get('analytics_retention_days', 90);
            ...
            $daysEventsRaw = \Modules\Core\Models\Setting::get('analytics_event_retention_days', 60);
            ...
            $daysSessionsRaw = \Modules\Core\Models\Setting::get('analytics_visitor_retention_days', 30);
