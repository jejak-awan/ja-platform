...
class SystemService
{
    ...
    public function getQueueHealth(): array
    {
        ...
        if ($driver !== 'sync') {
            try {
                \Modules\Core\Jobs\QueueHeartbeatJob::dispatch();
            } catch (\Throwable $e) {
    ...
    public function getStatistics(): array
    {
        ...
        try {
            ...
            $totalVisits = 0;
            try {
                if (class_exists(\Modules\Core\Models\PageView::class)) {
                    $totalVisits = \Modules\Core\Models\PageView::count();
                } elseif (class_exists(\Modules\Core\Models\Analytics::class)) {
                    $totalVisits = \Modules\Core\Models\Analytics::count();
                }
            } catch (\Exception $e) {
