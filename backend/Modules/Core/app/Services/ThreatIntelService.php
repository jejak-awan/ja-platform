...
class ThreatIntelService
{
    ...
    {
        $setting = \Modules\Core\Models\Setting::get('threat_intel_auto_block_threshold', self::AUTO_BLOCK_THRESHOLD);
    ...
    {
        $key = \Modules\Core\Models\Setting::get('abuseipdb_api_key');
