...
class FormController extends BaseApiController
{
    ...
    public function submit(Request $request, Form $form): \Illuminate\Http\JsonResponse
    {
        ...
        /** @var \Modules\Cms\Models\FormSubmission $submission */
     ...
     */
    protected function sendFormNotification(Form $form, \Modules\Cms\Models\FormSubmission $submission): void
    {
     ...
     *
     * @param  \Illuminate\Database\Eloquent\Collection<int, \Modules\Cms\Models\FormField>  $fields
     * @return array<string, array<int, string>>
     */
    private function extractRulesFromFields(\Illuminate\Database\Eloquent\Collection $fields): array
    {
    ...
    public function duplicate(Request $request, Form $form): \Illuminate\Http\JsonResponse
    {
        ...
        if ($copySubmissions) {
            ...
            $submissionsData = $form->submissions()->get()->map(function (\Modules\Cms\Models\FormSubmission $submission) use ($replicated) {
                return [
            ...
            if (! empty($submissionsData)) {
                \Modules\Cms\Models\FormSubmission::insert($submissionsData);
