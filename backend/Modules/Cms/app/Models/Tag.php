...
class Tag extends Model
{
    ...
    /** @use HasFactory<\Modules\System\Database\Factories\TagFactory> */
    use HasFactory, SoftDeletes;

    /**
     * Create a new factory instance for the model.
     */
    protected static function newFactory(): \Modules\System\Database\Factories\TagFactory
    {
        return \Modules\System\Database\Factories\TagFactory::new();
    }
    ...
    {
        return $this->belongsToMany(Media::class, 'cms_media_tag');
    }
}
