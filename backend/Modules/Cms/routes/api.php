...
Route::prefix('v1')->group(function (): void {
    // Public CMS API
    // Public CMS API (Surface canonical)
    Route::prefix('public/cms')->middleware('throttle:300,1')->group(function (): void {
    ...
    Route::prefix('manage/cms')->middleware(['auth:sanctum', 'throttle:admin-cms', 'bypass_unit_scope'])->group(function (): void {
        // Contents
