...
class SearchFunctionalityTest extends TestCase
{
    ...
    public function test_user_can_search_for_content(): void
    {
        ...
        $response = $this->getJson('/api/v1/ja/search?q=laravel');
    ...
    {
        $response = $this->getJson('/api/v1/ja/search?q=nonexistentterm12345');
    ...
    public function test_search_can_filter_by_type(): void
    {
        ...
        $response = $this->getJson('/api/v1/ja/search?q='.urlencode($uniqueTitle).'&type=post');
    ...
    public function test_search_suggestions_endpoint(): void
    {
        ...
        $response = $this->getJson('/api/v1/ja/search/suggestions?q=laravel');
    ...
    {
        $response = $this->getJson('/api/v1/ja/search?q=');
