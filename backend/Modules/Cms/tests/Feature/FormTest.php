...
class FormTest extends TestCase
{
    ...
    public function test_public_can_view_active_form(): void
    {
        ...
        $response = $this->getJson("/api/v1/ja/forms/{$form->slug}");
    ...
    public function test_public_can_submit_form(): void
    {
        ...
        $response = $this->postJson("/api/v1/ja/forms/{$form->slug}/submit", [
            'name' => 'John Doe',
    ...
    public function test_public_can_submit_form_with_file_field(): void
    {
        ...
        $response = $this->post("/api/v1/ja/forms/{$form->slug}/submit", [
            'title' => 'Hello',
            'doc' => $file,
        ]);
