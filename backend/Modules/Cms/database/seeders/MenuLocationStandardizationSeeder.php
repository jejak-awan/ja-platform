...
{
    /**
     * Recommended menu locations for Janari-like school themes.
     *
    ...
    private function seedThemeMenuLocationDefaults(): void
    {
        ...
        foreach (array_keys($this->standardLocations) as $location) {
            ...
            if (! isset($settings[$settingKey]) || $settings[$settingKey] === '' || $settings[$settingKey] === null) {
