...
class StaffController extends BaseController
{
    ...
    public function store(StoreStaffRequest $request): \Illuminate\Http\JsonResponse
    {
    ...
    public function show(Staff $staff): \Illuminate\Http\JsonResponse
    {
    ...
    public function update(UpdateStaffRequest $request, Staff $staff): \Illuminate\Http\JsonResponse
    {
