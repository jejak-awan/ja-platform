...
class SchoolController extends BaseController
{
     ...
     */
    public function updateSingleton(UpdateSchoolRequest $request): JsonResponse
    {
    ...
    public function checkSetupStatus(Request $request): JsonResponse
    {
        $this->authorize('viewAny', School::class);
    ...
    public function updateLogo(Request $request): JsonResponse
    {
        ...
        if ($request->hasFile('logo')) {
            ...
            return $this->sendResponse(['logo_url' => Storage::url((string) $path)], 'Logo uploaded successfully.');
        }

        return $this->sendError('No logo file found.', [], 400);
    }

    public function defaultSchool(): JsonResponse
    {
