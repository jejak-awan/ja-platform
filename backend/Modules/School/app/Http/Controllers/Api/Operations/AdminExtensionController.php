...
class AdminExtensionController extends BaseController
{
    ...
    public function updateLibraryBook(StoreLibraryBookRequest $request, string $id): JsonResponse
    {
    ...
    public function destroyLibraryBook(string $id): JsonResponse
    {
        /** @var LibraryBook $book */
        $book = LibraryBook::findOrFail($id);
    ...
    public function libraryCirculations(): JsonResponse
    {
    ...
    public function storeLibraryCirculation(StoreLibraryCirculationRequest $request): JsonResponse
    {
    ...
    public function updateLibraryCirculation(Request $request, string $id): JsonResponse
    {
    ...
    public function destroyLibraryCirculation(string $id): JsonResponse
    {
        /** @var LibraryCirculation $circulation */
        $circulation = LibraryCirculation::findOrFail($id);
    ...
    public function uksVisits(): JsonResponse
    {
    ...
    public function storeUksVisit(StoreUksVisitRequest $request): JsonResponse
    {
    ...
    public function updateUksVisit(StoreUksVisitRequest $request, string $id): JsonResponse
    {
        /** @var UksVisit $visit */
    ...
    public function destroyUksVisit(string $id): JsonResponse
    {
        /** @var UksVisit $visit */
        $visit = UksVisit::findOrFail($id);
    ...
    public function guestLogs(): JsonResponse
    {
    ...
    public function storeGuestLog(StoreGuestLogRequest $request): JsonResponse
    {
    ...
    public function updateGuestLog(StoreGuestLogRequest $request, string $id): JsonResponse
    {
        /** @var GuestLog $log */
    ...
    public function destroyGuestLog(string $id): JsonResponse
    {
        /** @var GuestLog $log */
        $log = GuestLog::findOrFail($id);
    ...
    public function storeAlumni(StoreAlumniRequest $request): JsonResponse
    {
    ...
    public function updateAlumni(StoreAlumniRequest $request, string $id): JsonResponse
    {
        /** @var Alumni $alumnus */
    ...
    public function destroyAlumni(string $id): JsonResponse
    {
        /** @var Alumni $alumnus */
        $alumnus = Alumni::findOrFail($id);
    ...
    public function tracerStudies(): JsonResponse
    {
    ...
    public function storeTracerStudy(StoreTracerStudyRequest $request): JsonResponse
    {
    ...
    public function updateTracerStudy(StoreTracerStudyRequest $request, string $id): JsonResponse
    {
    ...
    public function destroyTracerStudy(string $id): JsonResponse
    {
        /** @var TracerStudy $study */
        $study = TracerStudy::findOrFail($id);
