...
describe('Auth Store', () => {
    ...
    describe('Getters', () => {
        ...
        it(' isAdmin returns true for admin or super-admin', () => {
            const store = useAuthStore();
            store.user = mockUser as any;
            expect(store.isAdmin).toBe(true);

            store.user = { roles: [{ name: 'super-admin' }] } as any;
            expect(store.isAdmin).toBe(true);
        ...
        it('getRoleRank calculates correctly', () => {
            ...
            const otherUser = { roles: [{ name: 'super-admin' }] } as any;
            expect(store.getRoleRank(otherUser)).toBe(ROLE_RANKS['super-admin']);
        });
        ...
        it('isAtLeastRole checks rank correctly', () => {
            ...
            expect(store.isAtLeastRole('super-admin')).toBe(false);
        });
        ...
        it('isHigherThan compares roles correctly', () => {
            ...
            const superiorUser = { roles: [{ name: 'super-admin' }] } as any;
