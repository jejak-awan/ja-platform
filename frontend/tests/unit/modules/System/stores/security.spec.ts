...
describe('Security Store', () => {
    ...
    it('shows and hides shield', () => {
        ...
        expect(store.shieldStatus).toBe('features.security.shield.challenge.status.verifying');
    ...
    it('solves challenge successfully', async () => {
        ...
        expect(store.shieldStatus).toBe('features.security.shield.challenge.status.verified');
    ...
    it('handles challenge failure', async () => {
        ...
        expect(store.shieldStatus).toBe('features.security.shield.challenge.status.failed');
    });
