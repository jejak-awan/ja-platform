      ...
      >
        ...
        <div class="space-y-2">
          ...
          <p class="text-[10px] text-muted-foreground">
            {{ t('features.developer.custom_fields.fields.modal.name_help') }}
          </p>
        </div>
          ...
          >
            ...
            <SelectContent>
              <SelectItem value="none">
                {{ t('features.developer.custom_fields.fields.modal.group_none') }}
              </SelectItem>
              <SelectItem
        ...
        <div class="space-y-2">
          ...
          />
          <p class="text-[10px] text-muted-foreground">
            {{ t('features.developer.custom_fields.fields.modal.options_help') }}
          </p>
        </div>
