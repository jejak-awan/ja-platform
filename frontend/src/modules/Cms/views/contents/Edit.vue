...
import type { Content, ContentForm } from '@/modules/Cms/types/cms';
...
useHead({
    title: computed(() => `${form.value.title || t('modules.cms.content.form.editTitle')} | ${systemStore.siteSettings?.site_name || 'JA CMS'}`)
});
