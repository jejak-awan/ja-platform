...
const mockAnnouncements = [
    { date: '2026.04.16', category: 'OFFICIAL', title: 'Pemberitahuan Kelulusan Siswa Kelas XII Tahun Ajaran 2025/2026', url: '/pengumuman' },
    { date: '2026.04.10', category: 'PENTING', title: 'Update Juknis PPDB Jalur Prestasi dan Zonasi Periode 2', url: '/pengumuman' },
    { date: '2026.04.05', category: 'INFO', title: 'Pembagian Kartu Peserta Ujian Tengah Semester Genap', url: '/pengumuman' },
]

const mockAgenda = [
    { date: '2026.04.20', category: 'EVENT', title: 'Workshop Career Development: Build Your Future Together', url: '/agenda' },
    { date: '2026.04.25', category: 'AKADEMIK', title: 'Ujian Kompetensi Keahlian (UKK) Jurusan PPLG & TJKT', url: '/agenda' },
    { date: '2026.05.02', category: 'INTERNAL', title: 'Rapat Koordinasi Orang Tua Siswa & Komite Sekolah', url: '/agenda' },
]

const mockHolidays = [
    { date: '2026.05.01', category: 'NASIONAL', title: 'Hari Buruh Internasional - Sekolah Libur', url: '/agenda' },
    { date: '2026.05.13', category: 'NASIONAL', title: 'Hari Kenaikan Isa Almasih - Sekolah Libur', url: '/agenda' },
    { date: '2026.05.29', category: 'NASIONAL', title: 'Hari Raya Waisak 2570 BE - Sekolah Libur', url: '/agenda' },
]
...
function transformApiData(items: any[], defaultUrl: string) {
    ...
    return items.map(item => {
        ...
        return {
            ...
            category: raw?.category?.name || raw?.category_name || item?.category || 'INFO',
