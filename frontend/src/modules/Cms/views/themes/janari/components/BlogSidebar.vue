<template>
  <div class="space-y-10 sidebar-scroll-anchor-off">
    ...
    <!-- Widget: Kalender Akademik Minimalis -->
    <div class="space-y-6">
      <h3 class="text-sm font-bold text-muted-foreground uppercase tracking-wider flex items-center gap-2">
        <span class="w-1 h-4 bg-primary rounded-full" />
        Kalender Akademik
        ...
        <div class="space-y-6 relative z-10">
          ...
          >
            <div class="flex flex-col items-center shrink-0">
              ...
              <div v-if="idx < academicEvents.length - 1" class="w-px h-full bg-border my-2" />
            </div>
...
// Mock Data Kalender Akademik (Sesuai gaya Janari yang premium)
const academicEvents = [
  { day: '20', month: 'APR', title: 'Workshop Career Development: Membangun Masa Depan', time: '08:00 - 12:00' },
  { day: '25', month: 'APR', title: 'Ujian Kompetensi Keahlian (UKK) Gelombang 1', time: '07:30 - Selesai' },
  { day: '02', month: 'MEI', title: 'Rapat Koordinasi Orang Tua Siswa & Komite', time: '09:00 - 11:30' },
  { day: '15', month: 'MEI', title: 'Pelepasan Siswa Kelas XII Angkatan 2026', time: '08:00 - 15:00' },
]
