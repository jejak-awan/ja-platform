    ...
    <CardHeader class="pb-3">
      <div class="flex items-center justify-between">
        <CardTitle class="text-base">
          {{ t('modules.cms.menus.form.addItems') }}
        </CardTitle>
        <Button 
          variant="ghost" 
          size="icon" 
        ...
        <AccordionItem value="pages">
          <AccordionTrigger class="px-4 py-3 hover:no-underline hover:bg-muted/50">
            <div class="flex items-center gap-2 flex-1">
              ...
              <span>{{ t('modules.cms.menus.form.types.page') }}</span>
              <Badge
                variant="secondary"
                class="ml-2"
              >
              ...
              <Button 
                ...
                :title="t('modules.cms.menus.actions.addAll')" 
          ...
          <AccordionContent class="px-4 pb-4">
            <div class="max-h-[250px] overflow-y-auto pr-2 custom-scrollbar">
              ...
              >
                {{ t('modules.cms.menus.form.noPages') }}
              </div>
            </div>
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="posts">
          <AccordionTrigger class="px-4 py-3 hover:no-underline hover:bg-muted/50">
            <div class="flex items-center gap-2 flex-1">
              ...
              <span>{{ t('modules.cms.menus.form.types.post') }}</span>
              <Badge
                variant="secondary"
                class="ml-2"
              >
          ...
          <AccordionContent class="px-4 pb-4">
            <div class="max-h-[250px] overflow-y-auto pr-2 custom-scrollbar">
              ...
              <div
                ...
                class="text-center py-4 text-muted-foreground text-xs"
              >
                {{ t('modules.cms.menus.form.noPosts') }}
              </div>
            </div>
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="categories">
          <AccordionTrigger class="px-4 py-3 hover:no-underline hover:bg-muted/50">
            <div class="flex items-center gap-2 flex-1">
              ...
              <span>{{ t('modules.cms.menus.form.types.category') }}</span>
              <Badge
                variant="secondary"
                class="ml-2"
              >
          ...
          <AccordionContent class="px-4 pb-4">
            <div class="max-h-[250px] overflow-y-auto pr-2 custom-scrollbar">
              ...
              <div
                ...
                class="text-center py-4 text-muted-foreground text-xs"
              >
                {{ t('modules.cms.menus.form.noCategories') }}
              </div>
            </div>
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="custom">
          <AccordionTrigger class="px-4 py-3 hover:no-underline hover:bg-muted/50">
            <div class="flex items-center gap-2">
              ...
              <span>{{ t('modules.cms.menus.form.customLink') }}</span>
            </div>
          </AccordionTrigger>
          <AccordionContent class="px-4 pb-4 pt-2">
            <div class="space-y-3">
              <div class="space-y-1.5">
                <Label class="text-xs">{{ t('modules.cms.menus.form.linkText') }}</Label>
                <Input
              ...
              <div class="space-y-1.5">
                <Label class="text-xs">{{ t('modules.cms.menus.form.url') }}</Label>
                <Input
              ...
              >
                ...
                {{ t('modules.cms.menus.actions.addToMenu') }}
              </Button>
            </div>
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="structure">
          <AccordionTrigger class="px-4 py-3 hover:no-underline hover:bg-muted/50">
            <div class="flex items-center gap-2">
              ...
              <span>{{ t('modules.cms.menus.form.structure') }}</span>
            </div>
          </AccordionTrigger>
          <AccordionContent class="px-4 pb-4 pt-2">
            <Button 
            ...
            >
              ...
              {{ t('modules.cms.menus.form.addColumnGroup') }}
            </Button>
          </AccordionContent>
        </AccordionItem>
      </Accordion>
...
const addColumnGroup = () => {
    const item = menuItemRegistry.createInstance('column_group', {
        title: t('modules.cms.menus.form.newColumnGroup')
    });
    if (item) {
        menuContext.addItem(item);
    }
