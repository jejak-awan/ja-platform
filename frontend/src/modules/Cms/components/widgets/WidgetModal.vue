      ...
      >
          ...
          <Select v-model="form.type">
            ...
            <SelectContent>
              <SelectItem value="text">
                {{ $t('features.widgets.types.text') }}
              </SelectItem>
              <SelectItem value="html">
                {{ $t('features.widgets.types.html') }}
              </SelectItem>
              <SelectItem value="recent_posts">
                {{ $t('features.widgets.types.recent_posts') }}
              </SelectItem>
              <SelectItem value="categories">
                {{ $t('features.widgets.types.categories') }}
              </SelectItem>
              <SelectItem value="custom">
                {{ $t('features.widgets.types.custom') }}
              </SelectItem>
            </SelectContent>
          </Select>
          <span
        ...
        <div class="space-y-2">
          ...
          <Input
            ...
            type="text"
            :placeholder="$t('features.widgets.modals.widget.positionPlaceholder')"
          />
          <span
