            ...
            <div class="space-y-4">
              ...
              <div class="bg-muted/50 border border-border/40 rounded-xl p-3">
                <h4 class="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-2">
                  {{ $t('features.media.modals.view.details') }}
                </h4>
                <dl class="space-y-2 text-sm">
                  <div class="flex justify-between">
                    <dt class="text-muted-foreground">
                      {{ $t('features.media.modals.view.name') }}
                    </dt>
                  ...
                  <div class="flex justify-between">
                    <dt class="text-muted-foreground">
                      {{ $t('features.media.modals.view.type') }}
                    </dt>
                  ...
                  <div class="flex justify-between">
                    <dt class="text-muted-foreground">
                      {{ $t('features.media.modals.view.size') }}
                    </dt>
                    <dd class="text-foreground">
                  ...
                  >
                    <dt class="text-muted-foreground">
                      {{ $t('features.media.modals.view.folder') }}
                    </dt>
                    <dd class="text-foreground">
                      {{ media.folder.name }}
                    </dd>
                  ...
                  >
                    <dt class="text-muted-foreground">
                      {{ $t('features.media.modals.view.altText') }}
                    </dt>
              ...
              <div class="bg-muted/50 border border-border/40 rounded-xl p-3">
                <h4 class="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-2">
                  {{ $t('features.media.modals.view.url') }}
                </h4>
              ...
              <div class="bg-muted/50 border border-border/40 rounded-xl p-3">
                <h4 class="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-2">
                  {{ $t('features.media.modals.view.usage') }}
                </h4>
                <div
                  v-if="loadingUsage"
...
import type { Media } from '@/types/cms/cms';
