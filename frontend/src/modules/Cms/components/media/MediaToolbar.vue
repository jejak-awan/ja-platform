        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
            ...
            <Select v-model="mimeFilter">
              ...
              <SelectContent>
                <SelectItem value="all">
                  {{ $t('features.media.filter.allTypes') }}
                </SelectItem>
                <SelectItem value="image">
                  {{ $t('features.media.filter.images') }}
                </SelectItem>
                <SelectItem value="video">
                  {{ $t('features.media.filter.videos') }}
                </SelectItem>
                <SelectItem value="application">
                  {{ $t('features.media.filter.documents') }}
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div class="space-y-1.5 min-w-0">
            ...
            <Select v-model="usageFilter">
              ...
              <SelectContent>
                <SelectItem value="all">
                  {{ $t('features.media.filter.allStatus') }}
                </SelectItem>
                <SelectItem value="used">
                  {{ $t('features.media.filter.used') }}
                </SelectItem>
                <SelectItem value="unused">
                  {{ $t('features.media.filter.unused') }}
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div class="space-y-1.5 min-w-0">
            ...
            <Select v-model="authorFilterString">
              ...
              <SelectContent>
                <SelectItem value="all">
                  {{ $t('features.media.filter.allAuthors') }}
                </SelectItem>
                <SelectItem
