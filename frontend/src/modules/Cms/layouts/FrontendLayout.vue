...
import ThemePageResolver from '@/shared/components/ThemePageResolver.vue'
...
const viewModules = import.meta.glob('../views/themes/**/*.vue') as Record<string, () => Promise<unknown>>
