    ...
    >
      ...
      <div class="flex items-center justify-between px-6 py-4 border-b border-border bg-card/50 backdrop-blur-md z-10">
        <div class="text-sm font-medium text-foreground/80">
          {{ t('modules.system.media.modals.editor.title') }}
        </div>
...
import FlipHorizontal from 'lucide-vue-next/dist/esm/icons/flip-horizontal-2.js';
import FlipVertical from 'lucide-vue-next/dist/esm/icons/flip-vertical-2.js';
