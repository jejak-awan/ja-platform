<template>
  ...
  >
    ...
    >
      <DialogHeader>
        <DialogTitle>{{ $t('modules.system.media.modals.upload.title') }}</DialogTitle>
        <DialogDescription>
      ...
      <div class="py-4">
        ...
        >
          ...
          <div class="text-sm text-muted-foreground">
            <span class="text-primary font-medium group-hover/upload:underline">
              {{ $t('modules.system.media.modals.upload.clickToUpload') }}
            </span>
            {{ $t('modules.system.media.modals.upload.dragAndDrop') }}
          </div>
          <p class="mt-2 text-xs text-muted-foreground">
            {{ $t('modules.system.media.modals.upload.formats') }}
          </p>
        </div>
        ...
        >
          <h4 class="text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-3">
            {{ $t('modules.system.media.modals.upload.selectedFiles') }}
          </h4>
          <div
        ...
        >
          <div class="flex items-center justify-between mb-2">
            <span class="text-sm text-foreground">{{ $t('modules.system.media.modals.upload.uploading') }}</span>
      ...
      <DialogFooter>
        ...
        >
          ...
          />
          {{ uploading ? $t('modules.system.media.modals.upload.uploading') : $t('modules.system.media.modals.upload.uploadAction', { count: selectedFiles.length }) }}
        </Button>
      </DialogFooter>
    </DialogContent>
  </Dialog>
