  ...
  >
    ...
    >
      <h2 class="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/60 flex items-center">
        ...
        {{ $t('modules.system.media.folders') }}
      </h2>
    </div>
        ...
        <ContextMenuTrigger>
          ...
          >
            ...
            <Folder
              ...
              stroke-width="1.5"
            />
            <span class="truncate font-medium">{{ $t('modules.system.media.allMedia') }}</span>
          </button>
        </ContextMenuTrigger>
        <ContextMenuContent>
              ...
              >
                ...
                <div class="opacity-0 group-hover:opacity-100 flex items-center gap-1 z-20 relative ml-auto">
                  <button 
                    ...
                    :title="$t('modules.system.media.actions.delete')"
    ...
    >
      ...
      >
        ...
        />
        <span class="truncate font-semibold tracking-tight">{{ $t('modules.system.media.trash') }}</span>
