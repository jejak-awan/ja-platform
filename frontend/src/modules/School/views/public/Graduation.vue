              ...
              >
                <div class="space-y-3">
                  <Label class="text-[10px] font-black uppercase tracking-[0.2em] text-primary opacity-70 ml-2">
                    {{ $t('modules.school.operations.graduation.check.identifier') }}
                  </Label>
                ...
                <div class="space-y-3">
                  <Label class="text-[10px] font-black uppercase tracking-[0.2em] text-primary opacity-70 ml-2">
                    {{ $t('modules.school.operations.graduation.check.dob') }}
                  </Label>
                  <div class="relative group">
                ...
                <Button
                  ...
                  :loading="loading"
                >
                  {{ $t('modules.school.operations.graduation.check.btnCheck') }}
                </Button>
              </form>
            </CardContent>
          </Card>
            ...
            <div class="bg-card rounded-[3.8rem] p-12 text-center space-y-8">
              <div class="space-y-2">
                <p class="text-[10px] font-black uppercase tracking-[0.4em] opacity-40">
                  {{ $t('modules.school.operations.graduation.check.resultTitle') }}
                </p>
              ...
              <div :class="`py-10 px-6 rounded-[3rem] border-2 border-dashed ${result.is_graduated ? 'bg-success/5 border-success/30 text-success' : 'bg-destructive/5 border-destructive/30 text-destructive'} `">
                ...
                <p class="text-2xl font-black leading-tight uppercase italic tracking-tight">
                  {{ result.is_graduated ? $t('modules.school.operations.graduation.check.graduated') : $t('modules.school.operations.graduation.check.notGraduated') }}
                </p>
              </div>
              ...
              >
                <p class="text-sm text-muted-foreground font-medium leading-relaxed">
                  {{ $t('modules.school.operations.graduation.check.downloadHint') }}
                </p>
                <Button
                  variant="outline"
                ...
                >
                  ...
                  {{ $t('modules.school.operations.graduation.labels.btnDownloadSkl') }}
                </Button>
              </div>
            </div>
          </div>
