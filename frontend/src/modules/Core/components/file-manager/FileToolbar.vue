        ...
        <div class="flex items-center gap-0.5 sm:gap-1 text-sm shrink-0 min-w-0">
          <Tooltip>
            ...
            <TooltipContent side="bottom">
              {{ $t('features.file_manager.actions.home') }}
            </TooltipContent>
          </Tooltip>
          <template
          ...
          <div class="flex items-center gap-2">
            ...
            <div class="flex items-center gap-1 p-0.5 bg-accent/5 rounded-lg border border-border/40">
              ...
              <Tooltip>
                ...
                <TooltipContent side="bottom">
                  {{ $t('features.file_manager.actions.move') }}
                </TooltipContent>
              </Tooltip>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
            ...
            <Select v-model="filterType">
              ...
              <SelectContent>
                <SelectItem value="all">
                  {{ $t('features.file_manager.filter.all') }}
                </SelectItem>
                <SelectItem value="images">
                  {{ $t('features.file_manager.filter.images') }}
                </SelectItem>
                <SelectItem value="videos">
                  {{ $t('features.file_manager.filter.videos') }}
                </SelectItem>
                <SelectItem value="documents">
                  {{ $t('features.file_manager.filter.documents') }}
                </SelectItem>
                <SelectItem value="audio">
                  {{ $t('features.file_manager.filter.audio') }}
                </SelectItem>
                <SelectItem value="archives">
                  {{ $t('features.file_manager.filter.archives') }}
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div class="space-y-1.5 min-w-0">
            ...
            <Select v-model="authorFilterString">
              ...
              <SelectContent>
                <SelectItem value="all">
                  {{ $t('features.media.filter.allAuthors') || 'All Authors' }}
                </SelectItem>
                <SelectItem
