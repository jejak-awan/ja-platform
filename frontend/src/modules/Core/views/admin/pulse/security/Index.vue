...
const fetchShieldLogs = async (): Promise<void> => {
    ...
    try {
        const response = await api.get('/admin/core/security/shield/journal', { params: { page: shieldPage.value } });
...
const fetchShieldStats = async (): Promise<void> => {
    try {
        const response = await api.get('/admin/core/security/shield/stats');
...
const fetchLogs = async (): Promise<void> => {
    loading.value = true;
    try {
        const response = await api.get('/admin/core/security/journal', { params: { per_page: 100 } });
...
const clearShieldLogs = async (): Promise<void> => {
    ...
    try {
        await api.post('/admin/core/security/shield/clear');
...
const fetchStats = async (): Promise<void> => {
    try {
        const response = await api.get('/admin/core/security/stats');
...
const fetchSecurityKpi = async (): Promise<void> => {
    try {
        const response = await api.get('/admin/core/security/kpi', { params: { days: 30 } });
...
const fetchBlocklist = async (): Promise<void> => {
    try {
        const response = await api.get('/admin/core/security/blocklist');
...
const fetchWhitelist = async (): Promise<void> => {
    try {
        const response = await api.get('/admin/core/security/whitelist');
...
const blockIP = async (ip: string): Promise<void> => {
    ...
    if (!confirmed) return;
    try {
        await api.post('/admin/core/security/block-ip', { ip_address: ip });
...
const checkIPStatus = async (ip: string): Promise<void> => {
    try {
        const response = await api.get('/admin/core/security/check-ip', { params: { ip_address: ip } });
...
const bulkBlockFromLogs = async (ips: string[]): Promise<void> => {
    ...
    if (!confirmed) return;
    try {
        await api.post('/admin/core/security/bulk-block', { ip_addresses: ips });
...
const removeFromBlocklist = async (ip: string): Promise<void> => {
    ...
    if (!confirmed) return;
    try {
        await api.post('/admin/core/security/unblock-ip', { ip_address: ip });
...
const moveToWhitelist = async (ip: string): Promise<void> => {
    ...
    try {
        await api.post('/admin/core/security/unblock-ip', { ip_address: ip });
        await api.post('/admin/core/security/whitelist', { ip_address: ip });
...
const bulkUnblock = async (ips: string[]): Promise<void> => {
    ...
    if (!confirmed) return;
    try {
        await api.post('/admin/core/security/bulk-unblock', { ip_addresses: ips });
...
const removeFromWhitelist = async (ip: string): Promise<void> => {
    ...
    if (!confirmed) return;
    try {
        await api.post('/admin/core/security/remove-whitelist', { ip_address: ip });
...
const bulkRemoveWhitelist = async (ips: string[]): Promise<void> => {
    ...
    if (!confirmed) return;
    try {
        await api.post('/admin/core/security/bulk-remove-whitelist', { ip_addresses: ips });
...
const fetchCspReports = async (): Promise<void> => {
    ...
    try {
        ...
        const response = await api.get('/admin/core/security/csp-reports', { params });
        const result = response.data;
...
const fetchCspStats = async (): Promise<void> => {
    try {
        const response = await api.get('/admin/core/security/csp-reports/statistics');
...
const cspBulkAction = async (action: string, ids: number[]): Promise<void> => {
    ...
    if (!confirmed) return;
    try {
        await api.post('/admin/core/security/csp-reports/bulk-action', { ids, action });
...
const fetchSlowQueries = async (): Promise<void> => {
    ...
    try {
        const response = await api.get('/admin/core/security/slow-queries', { params: slowQueryFilters });
...
const fetchSlowQueryStats = async (): Promise<void> => {
    try {
        const response = await api.get('/admin/core/security/slow-queries/statistics');
...
const fetchVulnerabilities = async (): Promise<void> => {
    ...
    try {
        ...
        if (params.status === 'all') params.status = '';
        const response = await api.get('/admin/core/security/dependency-vulnerabilities', { params });
        const result = response.data;
...
const fetchVulnStats = async (): Promise<void> => {
    try {
        const response = await api.get('/admin/core/security/dependency-vulnerabilities/statistics');
...
const runDependencyAudit = async (): Promise<void> => {
    ...
    try {
        await api.post('/admin/core/security/run-dependency-audit');
...
const updateVulnStatus = async (vuln: Vulnerability, status: string): Promise<void> => {
    try {
        await api.put(`/admin/core/security/dependency-vulnerabilities/${vuln.id}`, { status });
        vuln.status = status;
...
const fetchThreatAnalysis = async (): Promise<void> => {
    ...
    try {
        const [analysisRes, logsRes] = await Promise.all([
            api.get('/admin/core/security/threat-analysis'),
            api.get('/admin/core/security/auto-tune/logs')
        ]);
...
const fetchFileIntegrity = async (): Promise<void> => {
    ...
    try {
        const response = await api.get('/admin/core/security/file-integrity');
...
const runIntegrityCheck = async (): Promise<void> => {
    integrityLoading.value = true;
    try {
        await api.post('/admin/core/security/run-integrity-check'); 
...
const submitIntegrityResync = async (): Promise<void> => {
    ...
    integrityLoading.value = true;
    try {
        await api.post('/admin/core/security/file-integrity/resync', {
            reason,
...
const fetchSecuritySettings = async (): Promise<void> => {
    try {
        const response = await api.get('/admin/core/security/settings');
...
const saveSecuritySettings = async (settings: { 
    ...
    try {
        await api.put('/admin/core/security/settings', settings);
...
const fetchMaintenanceStatus = async (): Promise<void> => {
    ...
    try {
        const response = await api.get('/admin/core/security/maintenance');
...
const activateMaintenance = async (modules: string[], duration: number): Promise<void> => {
    ...
    try {
        await api.post('/admin/core/security/maintenance/activate', { modules, duration });
...
const deactivateMaintenance = async (): Promise<void> => {
    maintenanceActivating.value = true;
    try {
        await api.post('/admin/core/security/maintenance/deactivate');
...
async function fetchSecurityHealth(): Promise<void> {
    try {
        const response = await api.get('/admin/core/security/health');
...
async function testNotification(): Promise<void> {
    try {
        await api.post('/admin/core/security/test-notification');
