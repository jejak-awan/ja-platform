    ...
    <CardHeader class="flex flex-row items-center justify-between pb-4">
      <div>
        <CardTitle class="text-lg">
          {{ $t('features.security.slowQueries.title') }}
        </CardTitle>
    ...
    <div class="px-6 pb-4 grid grid-cols-1 md:grid-cols-4 gap-4">
      <div class="bg-muted/30 rounded-lg p-4">
        <p class="text-sm text-muted-foreground">
          {{ $t('features.security.slowQueries.stats.total') }}
        </p>
      ...
      <div class="bg-muted/30 rounded-lg p-4">
        <p class="text-sm text-muted-foreground">
          {{ $t('features.security.slowQueries.stats.avgDuration') }}
        </p>
      ...
      <div class="bg-muted/30 rounded-lg p-4">
        <p class="text-sm text-muted-foreground">
          {{ $t('features.security.slowQueries.stats.maxDuration') }}
        </p>
      ...
      <div class="bg-muted/30 rounded-lg p-4">
        <p class="text-sm text-muted-foreground">
          {{ $t('features.security.slowQueries.stats.today') }}
        </p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div>
          ...
          <Input
            ...
            :placeholder="$t('features.security.slowQueries.filters.routePlaceholder')"
          />
        </div>
        <div>
