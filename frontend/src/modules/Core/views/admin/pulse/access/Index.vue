...
const fetchHistory = async (page: number = 1) : Promise<void> => {
    ...
    try {
        ...
        const response = await api.get(`/admin/core/access-journal?${params.toString()}`);
...
const fetchStatistics = async () : Promise<void> => {
    try {
        const response = await api.get('/admin/core/access-journal/statistics');
...
const fetchSuspicious = async () : Promise<void> => {
    try {
        const response = await api.get('/admin/core/access-journal/suspicious');
...
const exportHistory = async () : Promise<void> => {
    ...
    try {
        ...
        const response = await api.get(`/admin/core/access-journal/export?${params.toString()}`, {
            responseType: 'blob'
        });
