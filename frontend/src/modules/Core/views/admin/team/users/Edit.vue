...
const fetchRoles = async () => {
    ...
    try {
        const response = await api.get('/admin/core/roles');
...
const fetchUser = async () => {
    ...
    try {
        ...
        const response = await api.get(`/admin/core/users/${userId}`);
...
const handleSubmit = async () => {
    ...
    try {
        ...
        await api.put(`/admin/core/users/${route.params.id}`, payload);
