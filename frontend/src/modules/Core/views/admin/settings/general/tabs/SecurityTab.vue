...
const securitySettingsGrouped = computed(() => {
    ...
    const groups: SettingGroupData[] = [
        ...
        },
        {
            ...
            title: t('features.settings.groups.scannerProtection.title'),
            description: t('features.settings.groups.scannerProtection.description'),
            icon: BotIcon,
            color: 'orange',
        ...
        {
            id: 'threat-intel',
            title: t('features.settings.groups.threatIntel.title'),
            description: t('features.settings.groups.threatIntel.description'),
            icon: ShieldCheckIcon,
            color: 'orange',
        ...
        {
            id: 'notifications',
            title: t('features.settings.groups.securityNotifications.title'),
            description: t('features.settings.groups.securityNotifications.description'),
            icon: ShieldCheckIcon,
            color: 'pink',
