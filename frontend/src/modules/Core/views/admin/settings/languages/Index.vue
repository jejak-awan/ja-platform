...
const fetchLanguages = async () => {
    loading.value = true;
    try {
        const response = await api.get('/admin/core/languages');
...
const setDefault = async (lang: Language) => {
    try {
        await api.post(`/admin/core/languages/${lang.id}/set-default`);
...
const deleteLanguage = async (lang: Language) => {
    ...
    try {
        await api.delete(`/admin/core/languages/${lang.id}`);
        await fetchLanguages();
...
const createLanguage = async () => {
    ...
    clearErrors();
    try {
        await api.post('/admin/core/languages', {
...
const exportPack = async (lang: Language) => {
    ...
    try {
        const response = await api.get(`/admin/core/languages/${lang.id}/export-pack`, {
            responseType: 'blob',
        });
...
const importPack = async () => {
    ...
    try {
        ...
        await api.post('/admin/core/languages/import-pack', formData, {
