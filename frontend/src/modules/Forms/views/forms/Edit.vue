<template>
  <div class="space-y-6 pb-20">
    ...
    <div class="space-y-4">
        ...
        <div class="flex items-center gap-3">
          <div>
            <h1 class="text-2xl font-bold tracking-tight text-foreground">
              {{ $t('modules.cms.forms.modal.editTitle') }}
            </h1>
        ...
        <div class="flex items-center gap-3">
          ...
          >
            ...
            <Save
              ...
              class="mr-2 h-4 w-4"
            />
            {{ saving ? $t('common.messages.loading.saving') : $t('modules.cms.forms.actions.update') }}
          </Button>
        </div>
      </div>
      ...
      <Card
        v-if="loading"
        class="p-12 text-center border-border/60 shadow-none animate-pulse"
      >
      ...
      <Card
        v-else
        class="p-5 border-border/60 shadow-none mb-6"
      >
        ...
        <div class="mb-10 flex items-center justify-between">
          <TabsList class="bg-transparent p-0 h-auto gap-0">
            ...
            >
              ...
              {{ $t('modules.cms.forms.modal.tabs.fields') }}
            </TabsTrigger>
            <TabsTrigger
              value="settings"
              class="relative px-6 py-3 data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none transition-colors"
              ...
              <Card class="p-6 border-border/60 shadow-none h-fit space-y-4">
                ...
                <ul class="text-xs space-y-3 text-muted-foreground leading-relaxed">
                  <li class="flex items-start gap-2">
                    ...
                    {{ $t('modules.cms.forms.modal.publishingTips.edit') }}
                  </li>
                  <li class="flex items-start gap-2">
                    <div class="h-1 w-1 bg-primary rounded-full mt-1.5 shrink-0" />
