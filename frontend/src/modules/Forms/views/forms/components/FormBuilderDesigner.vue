                ...
                <div class="flex-1 min-w-0 p-4 sm:p-5 space-y-4">
                  <div class="flex flex-wrap items-start justify-between gap-3">
                    <div class="flex flex-wrap items-center gap-2 min-w-[200px] flex-1">
                      ...
                      >
                        <SelectTrigger class="h-9 w-[200px] max-w-full text-xs font-medium">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectItem
...
import Pilcrow from 'lucide-vue-next/dist/esm/icons/pilcrow.js';
...
import CircleDot from 'lucide-vue-next/dist/esm/icons/circle-dot.js';
