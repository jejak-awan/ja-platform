    ...
    <div class="mb-10 flex items-center justify-between">
      <div>
        <h1 class="text-3xl font-bold tracking-tight text-foreground">
          {{ $t('common.actions.create') }} {{ $t('modules.system.users.table.user') }}
        </h1>
        <p class="text-muted-foreground">
          {{ $t('modules.system.users.subtitleCreate') }}
        </p>
      </div>
    ...
    >
      ...
      <div class="bg-card border border-border/50 rounded-xl p-6 space-y-6 shadow-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="space-y-2">
            <label class="block text-sm font-medium text-foreground">
              {{ $t('modules.system.users.form.password') }} <span class="text-destructive">*</span>
            </label>
            <div class="relative">
              <Input
                ...
                :placeholder="$t('modules.system.users.form.placeholders.password') + ' (min 8, A-Z, a-z, 0-9)'"
              />
              <button
                type="button"
          ...
          <div class="space-y-2">
            <label class="block text-sm font-medium text-foreground">
              {{ $t('modules.system.users.form.passwordConfirmation') || 'Confirm Password' }} <span class="text-destructive">*</span>
            </label>
            <div class="relative">
              <Input
...
import { createUserSchema } from '@/modules/System/schemas/users';
import {
    Button,
    Input,
    Textarea,
