...
const fetchSettings = async () => {
    try {
        ...
        const securityKeys = [
            ...
            'email_to', 'webhook_url', 'admin_dashboard_slug'
        ];
        ...
        ensureSetting('admin_dashboard_slug', 'ja-dash', 'string', 'security');
        ...
        ensureSetting('site_name', 'JA-Platform', 'string', 'general');
        ...
        // Ensure SEO Settings
        ensureSetting('meta_title', 'JA-Platform', 'string', 'seo');
        ensureSetting('meta_description', 'Modern Platform', 'text', 'seo');
        ensureSetting('meta_keywords', 'ja-platform, school, portal', 'string', 'seo');
        ...
        ensureSetting('mail_from_address', 'hello@janari.com', 'string', 'email');
        ensureSetting('mail_from_name', 'Janari App', 'string', 'email');
        ...
        ensureSetting('gemini_model', '', 'string', 'ai');
...
const handleSubmit = async () => {
    ...
    try {
        ...
        const oldSlug = systemStore.adminDashboardSlug || 'dash';
        ...
        const newSlug = systemStore.adminDashboardSlug || 'dash';
        if (newSlug !== oldSlug) {
