...
const securitySettingsGrouped = computed(() => {
    ...
    const groups: SettingGroupData[] = [
        ...
        },
        {
            ...
            icon: ShieldCheckIcon,
            color: 'indigo',
            keys: ['admin_dashboard_slug', 'shield_protection_mode', 'shield_protection_difficulty', 'shield_enable_ip_intelligence', 'shield_allowed_countries', 'shield_log_verification_success'],
            settings: [],
            defaultExpanded: false,
        },
        {
