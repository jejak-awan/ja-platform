...
const monitoringSettingsGrouped = computed(() => {
    ...
    const groups: SettingGroupData[] = [
        {
            id: 'logs',
            title: t('modules.system.settings.groups.logs.title'),
            description: t('modules.system.settings.groups.logs.description'),
            icon: ActivityIcon,
            color: 'indigo',
        ...
        },
        {
            ...
            title: t('modules.system.settings.groups.backupMonitoring.title'),
            description: t('modules.system.settings.groups.backupMonitoring.description'),
            icon: ShieldIcon,
            color: 'blue',
