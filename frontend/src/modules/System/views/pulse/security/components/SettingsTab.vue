    ...
    <Card>
      <CardHeader>
        <CardTitle class="text-lg">
          {{ $t('features.security.settings.title') }}
        </CardTitle>
        <CardDescription>{{ $t('features.security.settings.description') }}</CardDescription>
      </CardHeader>
      <CardContent class="space-y-6">
        <!-- Security Log Retention -->
        <div class="space-y-2">
          <Label for="security-retention">{{ $t('features.security.settings.retentionDays.label') }}</Label>
          <p class="text-sm text-muted-foreground">
            {{ $t('features.security.settings.retentionDays.description') }}
          </p>
          <div class="flex items-center gap-3">
            <Input
              ...
              class="w-32"
            />
            <span class="text-sm text-muted-foreground">{{ $t('features.security.settings.retentionDays.unit') }}</span>
          </div>
        </div>
        ...
        <div class="space-y-2">
          <Label for="activity-retention">{{ $t('features.security.settings.activityRetention.label') }}</Label>
          <p class="text-sm text-muted-foreground">
            {{ $t('features.security.settings.activityRetention.description') }}
          </p>
          <div class="flex items-center gap-3">
            <Input
        ...
        <div class="space-y-2">
          <Label for="login-retention">{{ $t('features.security.settings.loginRetention.label') }}</Label>
          <p class="text-sm text-muted-foreground">
            {{ $t('features.security.settings.loginRetention.description') }}
          </p>
          <div class="flex items-center gap-3">
            <Input
              id="login-retention"
        ...
        <!-- Auto-Tune Frequency -->
        <div class="space-y-2">
          <Label for="autotune-freq">{{ $t('features.security.settings.autotuneFrequency.label') }}</Label>
          <p class="text-sm text-muted-foreground">
            {{ $t('features.security.settings.autotuneFrequency.description') }}
          </p>
          <select
            id="autotune-freq"
          ...
          >
            <option value="weekly">
              {{ $t('features.security.settings.autotuneFrequency.weekly') }}
            </option>
            <option value="daily">
              {{ $t('features.security.settings.autotuneFrequency.daily') }}
            </option>
          </select>
        </div>
      </CardContent>
