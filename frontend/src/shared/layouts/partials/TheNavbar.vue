      ...
      <div class="flex items-center space-x-4 ml-auto">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger as-child>
            <button
              class="relative flex items-center justify-center w-9 h-9 rounded-full text-muted-foreground hover:text-foreground hover:bg-primary/5 hover:ring-4 hover:ring-primary/10 hover:scale-110 active:scale-90 transition-all duration-300 focus:outline-none"
          ...
          <Tooltip>
            <TooltipTrigger as-child>
              <DropdownMenu>
                <DropdownMenuTrigger as-child>
                  <button
                    class="group relative flex items-center p-0.5 rounded-full hover:ring-4 hover:ring-primary/10 hover:scale-105 active:scale-95 transition-all duration-300 focus:outline-none"
