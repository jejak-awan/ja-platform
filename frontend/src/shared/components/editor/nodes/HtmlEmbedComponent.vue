    ...
    >
      ...
      >
        <button 
          ...
          :title="t('modules.cms.editor.actions.fit')"
          type="button"
          @click="fitToContent"
        >
        ...
        <button 
          ...
          :title="t('modules.cms.editor.actions.interact')"
          type="button"
        ...
        <button 
          ...
          :title="t('modules.cms.editor.actions.stopInteraction')"
          type="button"
      ...
      >
        ...
        <div class="text-sm font-medium">
          {{ t('modules.cms.editor.embed.empty') }}
        </div>
        <div class="text-xs opacity-75">
          {{ t('modules.cms.editor.embed.configure') }}
        </div>
      </div>
    </div>
  </node-view-wrapper>
