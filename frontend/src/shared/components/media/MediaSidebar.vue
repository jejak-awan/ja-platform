  ...
  >
        ...
        <ContextMenuTrigger>
          ...
          >
            ...
            <Folder
              ...
              stroke-width="1.5"
            />
            <span class="truncate font-medium">{{ $t('modules.core.media.allMedia') }}</span>
          </button>
        </ContextMenuTrigger>
        <ContextMenuContent>
              ...
              >
                ...
                <div class="opacity-0 group-hover:opacity-100 flex items-center gap-1 z-20 relative ml-auto">
                  <button 
                    ...
                    :title="$t('modules.core.media.actions.delete')"
    ...
    >
      ...
      >
        ...
        />
        <span class="truncate font-semibold tracking-tight">{{ $t('modules.core.media.trash') }}</span>
