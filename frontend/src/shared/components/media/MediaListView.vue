          ...
          <thead class="bg-muted/30">
            <tr>
              ...
              <th class="px-6 py-3 text-left w-16">
                {{ $t('modules.core.media.table.media') }}
              </th>
              <th 
              ...
              >
                <div class="flex items-center gap-2">
                  {{ $t('modules.core.media.table.name') }}
                </div>
                <!-- Resize Handle -->
                <div 
              ...
              <th class="px-6 py-3 text-left text-xs font-medium text-muted-foreground tracking-wider">
                {{ $t('modules.core.media.table.type') }}
              </th>
              <th class="px-6 py-3 text-left text-xs font-medium text-muted-foreground tracking-wider">
                {{ $t('modules.core.media.table.size') }}
              </th>
              <th class="px-6 py-3 text-left text-xs font-medium text-muted-foreground tracking-wider">
                {{ $t('modules.core.media.table.folder') }}
              </th>
              <th class="px-6 py-3 text-right text-xs font-medium text-muted-foreground tracking-wider">
                {{ $t('modules.core.media.table.actions') }}
              </th>
            </tr>
          </thead>
                ...
                >
                  ...
                  >
                    <div class="flex items-center gap-2 overflow-hidden">
                      ...
                      >
                        {{ $t('modules.core.media.shared') }}
                      </Badge>
                    </div>
                    <div class="text-xs text-muted-foreground">
                      {{ $t('modules.core.media.folder') }}
                    </div>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap">
                    <Badge
              ...
              <ContextMenuContent>
                ...
                <template v-else>
                  <ContextMenuItem @click="selectFolder(folder.id)">
                    ...
                    {{ $t('modules.core.media.actions.open') }}
                  </ContextMenuItem>
                  <ContextMenuSeparator />
                  <ContextMenuItem
                    class="text-destructive focus:bg-destructive/10 focus:text-destructive"
              ...
              <ContextMenuContent>
                ...
                <template v-else>
                  ...
                  <ContextMenuItem @click="downloadMedia(media)">
                    ...
                    {{ $t('modules.core.media.actions.download') }}
                  </ContextMenuItem>
                  <ContextMenuSeparator />
                  <ContextMenuItem @click="copyMediaUrl(media)">
                    ...
                    {{ $t('modules.core.media.actions.copyUrl') }}
                  </ContextMenuItem>
                  <ContextMenuSeparator />
                  <ContextMenuItem
                    class="text-destructive focus:bg-destructive/10 focus:text-destructive"
    ...
    <ContextMenuContent>
      <template v-if="!isTrashMode">
        ...
        <ContextMenuItem @click="fetchMedia(); fetchFolders();">
          <RefreshCw class="w-4 h-4 text-muted-foreground group-hover:text-primary transition-colors" />
          {{ $t('modules.core.media.actions.refresh') || 'Refresh' }}
        </ContextMenuItem>
      </template>
      <template v-else>
