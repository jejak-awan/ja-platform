      ...
      <div class="bg-card border border-border/40 shadow-none rounded-xl max-w-5xl w-full max-h-[90vh] flex flex-col">
            ...
            <div class="flex flex-col">
              <div v-if="media.mime_type?.startsWith('image/')">
                ...
                <div class="flex items-center justify-between mb-2">
                  <span class="text-xs font-medium text-muted-foreground">{{ $t('modules.core.media.modals.view.preview') }}</span>
                  <div class="flex items-center gap-0.5 bg-muted p-0.5 rounded-xl">
                    ...
                    >
                      <component
                        ...
                        class="w-3 h-3 mr-1"
                      />
                      {{ $t(`modules.core.media.modals.view.${mode.value}`) }}
                    </Button>
                  </div>
                </div>
                ...
                >
                  <Move
                    ...
                    stroke-width="1.5"
                  />
                  {{ $t('modules.core.media.modals.view.dragToPan') }}
                </p>
              </div>
              ...
              >
                ...
                >
                  <Edit
                    ...
                    stroke-width="1.5"
                  />
                  {{ $t('modules.core.media.modals.view.edit') }}
                </Button>
                <Button
                  size="sm"
                  variant="outline"
                ...
                >
                  <Scissors
                    ...
                    stroke-width="1.5"
                  />
                  {{ $t('modules.core.media.modals.view.resize') }}
                </Button>
                <Button
                  size="sm"
                  variant="outline"
                ...
                >
                  <RefreshCw
                    ...
                    stroke-width="1.5"
                  />
                  {{ generatingThumbnail ? $t('modules.core.media.modals.view.generating') : $t('modules.core.media.modals.view.thumbnail') }}
                </Button>
              </div>
            </div>
            ...
            <div class="space-y-4">
              ...
              <div class="bg-muted/50 border border-border/40 rounded-xl p-3">
                <h4 class="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-2">
                  {{ $t('modules.core.media.modals.view.details') }}
                </h4>
                <dl class="space-y-2 text-sm">
                  <div class="flex justify-between">
                    <dt class="text-muted-foreground">
                      {{ $t('modules.core.media.modals.view.name') }}
                    </dt>
                  ...
                  <div class="flex justify-between">
                    <dt class="text-muted-foreground">
                      {{ $t('modules.core.media.modals.view.type') }}
                    </dt>
                  ...
                  <div class="flex justify-between">
                    <dt class="text-muted-foreground">
                      {{ $t('modules.core.media.modals.view.size') }}
                    </dt>
                    <dd class="text-foreground">
                  ...
                  >
                    <dt class="text-muted-foreground">
                      {{ $t('modules.core.media.modals.view.folder') }}
                    </dt>
                    <dd class="text-foreground">
                      {{ media.folder.name }}
                    </dd>
                  ...
                  >
                    <dt class="text-muted-foreground">
                      {{ $t('modules.core.media.modals.view.altText') }}
                    </dt>
              ...
              >
                <h4 class="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-2">
                  {{ $t('modules.core.media.tags') || 'Tags' }}
                </h4>
              ...
              <div class="bg-muted/50 border border-border/40 rounded-xl p-3">
                <h4 class="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-2">
                  {{ $t('modules.core.media.modals.view.url') }}
                </h4>
              ...
              <div class="bg-muted/50 border border-border/40 rounded-xl p-3">
                <h4 class="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-2">
                  {{ $t('modules.core.media.modals.view.usage') }}
                </h4>
                <div
                  v-if="loadingUsage"
                  class="text-xs text-muted-foreground"
                >
                  {{ $t('modules.core.media.modals.view.loadingUsage') }}
                </div>
                <div
                ...
                <div
                  ...
                  class="text-xs text-muted-foreground"
                >
                  {{ $t('modules.core.media.modals.view.notUsed') }}
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="flex items-center justify-end px-5 py-3 border-t border-border/40 shrink-0">
          <Button
            ...
            @click="$emit('close')"
          >
            {{ $t('modules.core.media.modals.view.close') }}
          </Button>
        </div>
      </div>
    </div>
