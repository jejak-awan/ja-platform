      ...
      <div class="flex items-center gap-2 sm:gap-4 overflow-x-auto flex-nowrap custom-scrollbar overflow-y-hidden pb-1 items-center">
        ...
        <div class="flex-1 flex justify-center min-w-0">
          <div class="relative group w-full max-w-md">
            ...
            <Input
              v-model="search"
              type="text"
              :placeholder="$t('modules.core.media.search')"
        ...
        <div class="flex items-center gap-1 sm:gap-2 shrink-0">
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent
                ...
                align="center"
              >
                {{ $t('modules.core.media.filter.advanced') }}
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
          ...
          <Tooltip>
            ...
            <TooltipContent side="bottom">
              {{ viewMode === 'grid' ? $t('modules.core.media.views.list') : $t('modules.core.media.views.grid') }}
            </TooltipContent>
          </Tooltip>
        </div>
      </div>
        ...
        <div class="flex items-center justify-between gap-4 overflow-x-auto flex-nowrap custom-scrollbar pb-1">
          <div class="flex items-center gap-2">
            <div class="h-8 flex-shrink-0 flex items-center px-3 rounded-lg bg-primary/10 text-primary text-[10px] font-bold uppercase tracking-widest select-none border border-primary/20">
              {{ selectedMedia.length + selectedFolders.length }} <span class="hidden sm:inline ml-1">{{ $t('modules.core.media.selected', { count: '' }).trim() }}</span>
            </div>
                ...
                <Tooltip>
                  <TooltipTrigger as-child>
                    ...
                    >
                      ...
                      <span>{{ $t('modules.core.media.actions.downloadZip') }}</span>
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent side="bottom">
                    {{ $t('modules.core.media.actions.downloadZip') }}
                  </TooltipContent>
                </Tooltip>
                ...
                <Tooltip>
                  <TooltipTrigger as-child>
                    ...
                    >
                      ...
                      <span>{{ $t('modules.core.media.actions.move') }}</span>
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent side="bottom">
                    {{ $t('modules.core.media.actions.move') }}
                  </TooltipContent>
                </Tooltip>
                ...
                <Tooltip>
                  <TooltipTrigger as-child>
                    ...
                    >
                      ...
                      <span>{{ $t('modules.core.media.actions.updateAlt') }}</span>
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent side="bottom">
                    {{ $t('modules.core.media.actions.updateAlt') }}
                  </TooltipContent>
                </Tooltip>
                ...
                <Tooltip>
                  <TooltipTrigger as-child>
                    ...
                    >
                      ...
                      <span>{{ $t('modules.core.media.actions.delete') }}</span>
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent side="bottom">
                    {{ $t('modules.core.media.actions.delete') }}
                  </TooltipContent>
                </Tooltip>
              </template>
              ...
              <template v-else>
                <Tooltip>
                  <TooltipTrigger as-child>
                    ...
                    >
                      ...
                      <span>{{ $t('modules.core.media.actions.restore') }}</span>
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent side="bottom">
                    {{ $t('modules.core.media.actions.restore') }}
                  </TooltipContent>
                </Tooltip>
                ...
                <Tooltip>
                  <TooltipTrigger as-child>
                    ...
                    >
                      <Trash2 class="w-3.5 h-3.5 mr-1.5" />
                      <span>{{ $t('modules.core.media.actions.deletePermanent') }}</span>
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent side="bottom">
                    {{ $t('modules.core.media.actions.deletePermanent') }}
                  </TooltipContent>
                </Tooltip>
              </template>
            </div>
          ...
          <Tooltip>
            <TooltipTrigger as-child>
              ...
              >
                {{ $t('modules.core.media.actions.clearSelection') }}
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
          ...
          <div class="space-y-1.5 min-w-0">
            <label class="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/80 ml-1">
              {{ $t('modules.core.media.filter.type') }}
            </label>
            <Select v-model="mimeFilter">
              <SelectTrigger class="bg-background h-10 border-border/40 rounded-lg w-full">
                <SelectValue :placeholder="$t('modules.core.media.filter.allTypes')" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="all">
                  {{ $t('modules.core.media.filter.allTypes') }}
                </SelectItem>
                <SelectItem value="image">
                  {{ $t('modules.core.media.filter.images') }}
                </SelectItem>
                <SelectItem value="video">
                  {{ $t('modules.core.media.filter.videos') }}
                </SelectItem>
                <SelectItem value="application">
                  {{ $t('modules.core.media.filter.documents') }}
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div class="space-y-1.5 min-w-0">
            <label class="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/80 ml-1">
              {{ $t('modules.core.media.filter.status') }}
            </label>
            <Select v-model="usageFilter">
              <SelectTrigger class="bg-background h-10 border-border/40 rounded-lg w-full">
                <SelectValue :placeholder="$t('modules.core.media.filter.allStatus')" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="all">
                  {{ $t('modules.core.media.filter.allStatus') }}
                </SelectItem>
                <SelectItem value="used">
                  {{ $t('modules.core.media.filter.used') }}
                </SelectItem>
                <SelectItem value="unused">
                  {{ $t('modules.core.media.filter.unused') }}
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div class="space-y-1.5 min-w-0">
            <label class="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/80 ml-1">
              {{ $t('modules.core.media.filter.author') }}
            </label>
            <Select v-model="authorFilterString">
              <SelectTrigger class="bg-background h-10 border-border/40 rounded-lg w-full">
                <SelectValue :placeholder="$t('modules.core.media.filter.allAuthors')" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="all">
                  {{ $t('modules.core.media.filter.allAuthors') }}
                </SelectItem>
                <SelectItem
          ...
          <div class="space-y-1.5 min-w-0">
            <label class="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/80 ml-1">
              {{ $t('modules.core.media.filter.size') }}
            </label>
          ...
          <div class="space-y-1.5 min-w-0 xl:col-span-2">
            <label class="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/80 ml-1">
              {{ $t('modules.core.media.filter.dateRange') }}
            </label>
            <div class="flex items-center gap-1.5">
              <Input 
